...
const BackgroundWave2 = ({ style, className }: BackgroundWavePorps) => {
  const width = Dimensions.get("screen").width
  const height = Dimensions.get("screen").height
  return (
    
    <View style={style} className={className}>
      <View style={{ backgroundColor: "#d71a1a", width: "100%", height: 130 }}>
        <Svg
        ...
        >
          <Path
            fill="#d71a1a"
            d="m0 160 48 10.7C96 181 192 203 288 224s192 43 288 21.3c96-21.3 192-85.3 288-112 96-26.3 192-16.3 288 10.7s192 69 240 90.7l48 21.3V0H0Z"
          />
          {/* <Path
...
export default BackgroundWave2;
